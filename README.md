...
### тдавайте предпочтение классам (ES2015 / ES6) над простыми функциями (ES5)
...
Также доступна на других языках:
  ...
  - ![ru](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/South-Korea.png) **Russian**: [qkraudghgh/clean-code-javascript-ko](https://github.com/qkraudghgh/clean-code-javascript-ro)
